...
3. **Сетевой режим** - логи пишутся и в файл, и отправляются по сети:
...
2. Соберите проект с флагом для тестов:
   ...
   ```
 3.1. Запуск тестирования библиотеки и приложения журналирования:
   ```
   ./journal_tests
   ```
 3.2. Запуск тестирования программы для сбора статистики:
   ```
   ./stats_tests
   ```
